...
public class SqlServer {
    ...
    public String convertToPageSql(String sql, int offset, int limit) {
        ...
        //获取分页查询的select
        Select pageSelect = getPageSelect((Select) stmt,offset,limit);
     ...
     * @return
     */
    protected Select getPageSelect(Select select,int offset, int limit) {
        ...
        greaterThan.setRightExpression(new LongValue( offset ));
